    ...
    <div className="p-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm">Organized view of your academic ecosystem.</p>
        </div>
        <button
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
        ...
        {filteredStudents.length === 0 && (
          <div className="py-32 text-center">
            <GraduationCap size={48} className="mx-auto text-slate-800 mb-4" />
            <p className="text-slate-500">No students found in this specific class.</p>
          </div>
        )}
      </div>
    </div>
